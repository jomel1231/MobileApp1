...
const Module3QuizScreen = () => {
  const navigation = useNavigation();

  const [selectedAnswer, setSelectedAnswer] = useState(null);
  const [isCorrect, setIsCorrect] = useState(false);
  const correctAnswer = "Tweezers";
    ...
    >
      <View style={styles.container}>
        ...
        <View style={styles.quizContainer}>
          ...
          Which tool is used to safely open a phone casing without damaging it?
          </Text>

          {["Screwdriver", "Tweezers", "Spudger"].map(
            (answer) => (
              <TouchableOpacity
                key={answer}
                style={[
...
export default Module3QuizScreen;
